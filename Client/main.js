...
resumeParser.service("resumeService", function () {
    ...
    this.download = function(){
        var encodedUri = "data:text/json;charset=utf-16," + encodeURIComponent(JSON.stringify({"reqSkills":this.matchedSkills.trim().split(","), "degree": this.degree }));
